...
.method public getCurrentControllerInfo()Landroidx/media/MediaSessionManager$RemoteUserInfo;
    ...
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase$MessageHandler;->getRemoteUserInfo()Landroidx/media/MediaSessionManager$RemoteUserInfo;
...
.method public setPlaybackState(Landroidx/media/MediaSessionManager$RemoteUserInfo;Landroid/support/v4/media/session/PlaybackStateCompat;)V
    .locals 2
    ...
    :try_start_0
    iput-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mState:Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    invoke-virtual {v1, p1}, Landroidx/media/MediaSessionManager$RemoteUserInfo;->equals(Ljava/lang/Object;)Z
    ...
    :try_start_1
    invoke-interface {v1, p2}, Landroid/support/v4/media/session/IMediaControllerCallback;->onPlaybackStateChanged(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    :try_end_1
