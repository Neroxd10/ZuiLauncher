...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;

    return-void
.end method

.method static synthetic a(Lcom/android/systemui/shared/plugins/VersionInfo;Ljava/lang/Class;)Lcom/android/systemui/shared/plugins/VersionInfo$c;
    .locals 0

    invoke-direct {p0, p1}, Lcom/android/systemui/shared/plugins/VersionInfo;->c(Ljava/lang/Class;)Lcom/android/systemui/shared/plugins/VersionInfo$c;
...
.method private b(Ljava/lang/Class;Z)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;
    ...
    iget-object v2, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;

    new-instance v3, Lcom/android/systemui/shared/plugins/VersionInfo$c;

    invoke-interface {v0}, Lcom/android/systemui/plugins/annotations/ProvidesInterface;->version()I

    move-result v0

    invoke-direct {v3, v0, v1}, Lcom/android/systemui/shared/plugins/VersionInfo$c;-><init>(IZ)V
    ...
    new-instance v4, Lcom/android/systemui/shared/plugins/VersionInfo$c;

    invoke-interface {v0}, Lcom/android/systemui/plugins/annotations/Requires;->version()I

    move-result v0

    invoke-direct {v4, v0, p2}, Lcom/android/systemui/shared/plugins/VersionInfo$c;-><init>(IZ)V
    ...
    iget-object v6, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;

    invoke-interface {v5}, Lcom/android/systemui/plugins/annotations/Requires;->target()Ljava/lang/Class;

    move-result-object v7

    new-instance v8, Lcom/android/systemui/shared/plugins/VersionInfo$c;

    invoke-interface {v5}, Lcom/android/systemui/plugins/annotations/Requires;->version()I

    move-result v5

    invoke-direct {v8, v5, p2}, Lcom/android/systemui/shared/plugins/VersionInfo$c;-><init>(IZ)V
    ...
    invoke-direct {p0, p2, v1}, Lcom/android/systemui/shared/plugins/VersionInfo;->b(Ljava/lang/Class;Z)V
    ...
    invoke-direct {p0, v0, v1}, Lcom/android/systemui/shared/plugins/VersionInfo;->b(Ljava/lang/Class;Z)V
...
.method private c(Ljava/lang/Class;)Lcom/android/systemui/shared/plugins/VersionInfo$c;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance p1, Lcom/android/systemui/shared/plugins/VersionInfo$c;
    ...
    invoke-direct {p1, p0, v0}, Lcom/android/systemui/shared/plugins/VersionInfo$c;-><init>(IZ)V
...
.method public addClass(Ljava/lang/Class;)Lcom/android/systemui/shared/plugins/VersionInfo;
    ...
    iget-object v0, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->b:Ljava/lang/Class;

    if-nez v0, :cond_0

    iput-object p1, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->b:Ljava/lang/Class;

    :cond_0
    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, Lcom/android/systemui/shared/plugins/VersionInfo;->b(Ljava/lang/Class;Z)V
...
.method public checkVersion(Lcom/android/systemui/shared/plugins/VersionInfo;)V
    ...
    iget-object v1, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;

    invoke-direct {v0, v1}, Landroid/util/ArrayMap;-><init>(Landroid/util/ArrayMap;)V

    iget-object p1, p1, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;

    new-instance v1, Lcom/android/systemui/shared/plugins/VersionInfo$a;

    invoke-direct {v1, p0, v0}, Lcom/android/systemui/shared/plugins/VersionInfo$a;-><init>(Lcom/android/systemui/shared/plugins/VersionInfo;Landroid/util/ArrayMap;)V

    invoke-virtual {p1, v1}, Landroid/util/ArrayMap;->forEach(Ljava/util/function/BiConsumer;)V

    new-instance p1, Lcom/android/systemui/shared/plugins/VersionInfo$b;

    invoke-direct {p1, p0}, Lcom/android/systemui/shared/plugins/VersionInfo$b;-><init>(Lcom/android/systemui/shared/plugins/VersionInfo;)V
...
.method public getDefaultVersion()I
    ...
    iget-object p0, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->b:Ljava/lang/Class;

    invoke-virtual {v0, p0}, Landroid/util/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/android/systemui/shared/plugins/VersionInfo$c;

    invoke-static {p0}, Lcom/android/systemui/shared/plugins/VersionInfo$c;->a(Lcom/android/systemui/shared/plugins/VersionInfo$c;)I
...
.method public hasClass(Ljava/lang/Class;)Z
    ...
    iget-object p0, p0, Lcom/android/systemui/shared/plugins/VersionInfo;->a:Landroid/util/ArrayMap;
