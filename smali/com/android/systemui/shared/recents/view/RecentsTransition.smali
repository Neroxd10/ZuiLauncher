...
.method public static createAspectScaleAnimation(Landroid/content/Context;Landroid/os/Handler;ZLcom/android/systemui/shared/recents/view/AppTransitionAnimationSpecsFuture;Ljava/lang/Runnable;)Landroid/app/ActivityOptions;
    ...
    new-instance v0, Lcom/android/systemui/shared/recents/view/RecentsTransition$a;

    invoke-direct {v0, p4}, Lcom/android/systemui/shared/recents/view/RecentsTransition$a;-><init>(Ljava/lang/Runnable;)V
...
.method public static drawViewIntoHardwareBitmap(IILandroid/view/View;FI)Landroid/graphics/Bitmap;
    ...
    new-instance v0, Lcom/android/systemui/shared/recents/view/RecentsTransition$c;

    invoke-direct {v0, p3, p4, p2}, Lcom/android/systemui/shared/recents/view/RecentsTransition$c;-><init>(FILandroid/view/View;)V
...
.method public static wrapStartedListener(Landroid/os/Handler;Ljava/lang/Runnable;)Landroid/os/IRemoteCallback;
    ...
    :cond_0
    new-instance v0, Lcom/android/systemui/shared/recents/view/RecentsTransition$b;

    invoke-direct {v0, p0, p1}, Lcom/android/systemui/shared/recents/view/RecentsTransition$b;-><init>(Landroid/os/Handler;Ljava/lang/Runnable;)V
