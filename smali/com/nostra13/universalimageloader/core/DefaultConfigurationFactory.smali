...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory$a;
    }
.end annotation
...
.method private static b(ILjava/lang/String;)Ljava/util/concurrent/ThreadFactory;
    .locals 1

    new-instance v0, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory$a;

    invoke-direct {v0, p0, p1}, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory$a;-><init>(ILjava/lang/String;)V

    return-object v0
.end method

.method private static c(Landroid/app/ActivityManager;)I
    .locals 0
...
.method public static createExecutor(IILcom/nostra13/universalimageloader/core/assist/QueueProcessingType;)Ljava/util/concurrent/Executor;
    ...
    invoke-static {p1, v0}, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory;->b(ILjava/lang/String;)Ljava/util/concurrent/ThreadFactory;
...
.method public static createMemoryCache(Landroid/content/Context;I)Lcom/nostra13/universalimageloader/cache/memory/MemoryCache;
    ...
    invoke-static {}, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-static {p0}, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory;->e(Landroid/content/Context;)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-static {p1}, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory;->c(Landroid/app/ActivityManager;)I
...
.method public static createTaskDistributor()Ljava/util/concurrent/Executor;
    ...
    invoke-static {v0, v1}, Lcom/nostra13/universalimageloader/core/DefaultConfigurationFactory;->b(ILjava/lang/String;)Ljava/util/concurrent/ThreadFactory;
