...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/CalendarBackupTask$a;
    }
.end annotation
...
.method public constructor <init>(Lcom/lenovo/leos/cloud/lcp/sync/modules/common/TaskID;)V
    ...
    iput-object p1, p0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/CalendarBackupTask;->g:Landroid/content/Context;
...
.method protected getDefaultTrackType()Ljava/lang/String;
    ...
    const-string p0, "V1_CALENDAR_BACKUP_DEFAULT_FINISH"
...
.method protected startCalendarSupportTask()Landroid/os/Bundle;
    ...
    const-string p0, "\u6682\u4e0d\u63d0\u4f9b\u5355\u72ec\u5907\u4efd\u751f\u65e5\u4ee3\u529e\u4efb\u52a1"
...
.method protected startMainEventTask()V
    ...
    new-instance v0, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/CalendarBackupTask$a;

    invoke-direct {v0, p0, p0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/CalendarBackupTask$a;-><init>(Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/CalendarBackupTask;Lcom/lenovo/leos/cloud/lcp/common/StepProgressListener;)V
    ...
    :try_start_0
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/MainEventBackupStep;->doCheckSum()Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/EventChecksumResponse;
    ...
    invoke-virtual {v1, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/MainEventBackupStep;->doAction(Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/EventChecksumResponse;)Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/MainEventBackupResponse;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v1, v0}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/MainEventBackupStep;->handleResult(Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/MainEventBackupResponse;)Lcom/lenovo/leos/cloud/lcp/sync/modules/contact/manager/vo/TaskResult;
...
.method protected startSubEventTask()V
    ...
    :try_start_0
    invoke-virtual {v1}, Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/task/backup/SubEventBackupStep;->doCheckSum()Lcom/lenovo/leos/cloud/lcp/sync/modules/calendar/cloud/protocol/EventChecksumResponse;
