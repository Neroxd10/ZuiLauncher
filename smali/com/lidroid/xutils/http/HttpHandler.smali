...
.method public constructor <init>(Lorg/apache/http/impl/client/AbstractHttpClient;Lorg/apache/http/protocol/HttpContext;Ljava/lang/String;Lcom/lidroid/xutils/http/callback/RequestCallBack;)V
    ...
    sget-object p0, Lcom/lidroid/xutils/http/HttpHandler;->notUseApacheRedirectHandler:Lcom/lidroid/xutils/http/HttpHandler$NotUseApacheRedirectHandler;

    invoke-virtual {p1, p0}, Lorg/apache/http/impl/client/AbstractHttpClient;->setRedirectHandler(Lorg/apache/http/client/RedirectHandler;)V
...
.method private handleResponse(Lorg/apache/http/HttpResponse;)Lcom/lidroid/xutils/http/ResponseInfo;
    ...
    :cond_4
    :goto_1
    new-instance p0, Lcom/lidroid/xutils/http/ResponseInfo;

    invoke-direct {p0, p1, v1, v0}, Lcom/lidroid/xutils/http/ResponseInfo;-><init>(Lorg/apache/http/HttpResponse;Ljava/lang/Object;Z)V
    ...
    new-instance p0, Lcom/lidroid/xutils/exception/HttpException;

    const-string p1, "maybe the file has downloaded completely"

    invoke-direct {p0, v2, p1}, Lcom/lidroid/xutils/exception/HttpException;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/lidroid/xutils/exception/HttpException;-><init>(Ljava/lang/String;)V
...
.method private sendRequest(Lorg/apache/http/client/methods/HttpRequestBase;)Lcom/lidroid/xutils/http/ResponseInfo;
    ...
    invoke-direct {p0, v3}, Lcom/lidroid/xutils/exception/HttpException;-><init>(Ljava/lang/Throwable;)V
...
.method public cancel()V
    ...
    :catchall_1
    :cond_1
    iget-object p0, p0, Lcom/lidroid/xutils/http/HttpHandler;->callback:Lcom/lidroid/xutils/http/callback/RequestCallBack;

    if-eqz p0, :cond_2

    invoke-virtual {p0}, Lcom/lidroid/xutils/http/callback/RequestCallBack;->onCancelled()V
...
.method public getState()Lcom/lidroid/xutils/http/HttpHandler$State;
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/http/HttpHandler;->state:Lcom/lidroid/xutils/http/HttpHandler$State;
...
.method protected varargs onProgressUpdate([Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/lidroid/xutils/http/callback/RequestCallBack;->onSuccess(Lcom/lidroid/xutils/http/ResponseInfo;)V
    ...
    invoke-virtual {p0, v0, p1}, Lcom/lidroid/xutils/http/callback/RequestCallBack;->onFailure(Lcom/lidroid/xutils/exception/HttpException;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/lidroid/xutils/http/callback/RequestCallBack;->onStart()V
...
.method public updateProgress(JJZ)Z
    ...
    sget-object p1, Lcom/lidroid/xutils/http/HttpHandler$State;->CANCELLED:Lcom/lidroid/xutils/http/HttpHandler$State;
