...
.method public constructor <init>(Ljava/util/Collection;)V
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/task/PriorityObjectBlockingQueue;->count:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private signalNotEmpty()V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/lidroid/xutils/task/PriorityObjectBlockingQueue;->notEmpty:Ljava/util/concurrent/locks/Condition;
...
.method private signalNotFull()V
    ...
    :try_start_0
    iget-object p0, p0, Lcom/lidroid/xutils/task/PriorityObjectBlockingQueue;->notFull:Ljava/util/concurrent/locks/Condition;
...
.method public drainTo(Ljava/util/Collection;I)I
    ...
    :cond_3
    :try_start_1
    iget-object v6, v3, Lcom/lidroid/xutils/task/Node;->next:Lcom/lidroid/xutils/task/Node;

    invoke-virtual {v6}, Lcom/lidroid/xutils/task/Node;->getValue()Ljava/lang/Object;

    move-result-object v7

    invoke-interface {p1, v7}, Ljava/util/Collection;->add(Ljava/lang/Object;)Z

    invoke-virtual {v6, v0}, Lcom/lidroid/xutils/task/Node;->setValue(Ljava/lang/Object;)V
...
.method fullyLock()V
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/task/PriorityObjectBlockingQueue;->takeLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method fullyUnlock()V
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/task/PriorityObjectBlockingQueue;->putLock:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public peek()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object p0, p0, Lcom/lidroid/xutils/task/PriorityObjectBlockingQueue;->head:Lcom/lidroid/xutils/task/Node;

    iget-object p0, p0, Lcom/lidroid/xutils/task/Node;->next:Lcom/lidroid/xutils/task/Node;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0}, Lcom/lidroid/xutils/task/Node;->getValue()Ljava/lang/Object;
