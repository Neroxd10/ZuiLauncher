...
.method private constructor <init>(Lcom/lidroid/xutils/DbUtils$DaoConfig;)V
    ...
    const-string p1, "daoConfig may not be null"
...
.method private beginTransaction()V
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/DbUtils;->database:Landroid/database/sqlite/SQLiteDatabase;
...
.method private debugSql(Ljava/lang/String;)V
    ...
    iget-boolean p0, p0, Lcom/lidroid/xutils/DbUtils;->debug:Z
...
.method private getLastAutoIncrementId(Ljava/lang/String;)J
    ...
    :cond_0
    invoke-static {p0}, Lcom/lidroid/xutils/util/IOUtils;->closeQuietly(Landroid/database/Cursor;)V
...
.method public count(Lcom/lidroid/xutils/db/sqlite/Selector;)J
    ...
    invoke-virtual {p0, p1}, Lcom/lidroid/xutils/db/table/DbModel;->getLong(Ljava/lang/String;)J
...
.method public dropDb()V
    ...
    invoke-direct {v1, p0}, Lcom/lidroid/xutils/exception/DbException;-><init>(Ljava/lang/Throwable;)V
...
.method public execNonQuery(Lcom/lidroid/xutils/db/sqlite/SqlInfo;)V
    ...
    invoke-direct {p1, p0}, Lcom/lidroid/xutils/exception/DbException;-><init>(Ljava/lang/Throwable;)V
...
.method public findAll(Lcom/lidroid/xutils/db/sqlite/Selector;)Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/DbUtils;->findTempCache:Lcom/lidroid/xutils/DbUtils$FindTempCache;

    invoke-virtual {p0, v0, v3}, Lcom/lidroid/xutils/DbUtils$FindTempCache;->put(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public findById(Ljava/lang/Class;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p2, p1}, Lcom/lidroid/xutils/DbUtils$FindTempCache;->put(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public findDbModelAll(Lcom/lidroid/xutils/db/sqlite/DbModelSelector;)Ljava/util/List;
    ...
    :cond_1
    :try_start_1
    invoke-static {p0}, Lcom/lidroid/xutils/db/sqlite/CursorUtils;->getDbModel(Landroid/database/Cursor;)Lcom/lidroid/xutils/db/table/DbModel;
...
.method public findFirst(Lcom/lidroid/xutils/db/sqlite/Selector;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/lidroid/xutils/DbUtils$FindTempCache;->put(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public getDaoConfig()Lcom/lidroid/xutils/DbUtils$DaoConfig;
    ...
    iget-object p0, p0, Lcom/lidroid/xutils/DbUtils;->daoConfig:Lcom/lidroid/xutils/DbUtils$DaoConfig;
