.class public final Lcom/amap/api/col/l3s/az;
...
.field private e:Lcom/amap/api/col/l3s/ft;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/amap/api/col/l3s/az;->c:Landroid/os/Bundle;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/amap/api/col/l3s/az;->a:Z

    const-wide/16 v0, 0x7d0

    iput-wide v0, p0, Lcom/amap/api/col/l3s/az;->b:J

    iput-object p1, p0, Lcom/amap/api/col/l3s/az;->g:Landroid/content/Context;
...
.method private a(Z)V
    ...
    iget-object v0, p0, Lcom/amap/api/col/l3s/az;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lcom/amap/api/col/l3s/ft;->c()V

    new-instance v0, Lcom/amap/api/col/l3s/ft;

    iget-object v1, p0, Lcom/amap/api/col/l3s/az;->g:Landroid/content/Context;

    invoke-direct {v0, v1}, Lcom/amap/api/col/l3s/ft;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    invoke-virtual {v0, p0}, Lcom/amap/api/col/l3s/ft;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V
    ...
    iget-wide v1, p0, Lcom/amap/api/col/l3s/az;->b:J
    ...
    iget-object v1, p0, Lcom/amap/api/col/l3s/az;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    invoke-virtual {v0, v1}, Lcom/amap/api/col/l3s/ft;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V

    iget-object v0, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    invoke-virtual {v0}, Lcom/amap/api/col/l3s/ft;->a()V

    :cond_1
    iput-boolean p1, p0, Lcom/amap/api/col/l3s/az;->a:Z
...
.method public final a(I)V
    ...
    invoke-direct {p0, p1}, Lcom/amap/api/col/l3s/az;->a(Z)V

    return-void

    :cond_1
    :goto_0
    invoke-direct {p0, v0}, Lcom/amap/api/col/l3s/az;->a(Z)V
...
.method public final a(J)V
    ...
    iget-object v1, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;
    ...
    :cond_0
    iput-wide p1, p0, Lcom/amap/api/col/l3s/az;->b:J
...
.method public final activate(Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/az;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;

    iget-object p1, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    if-nez p1, :cond_0

    new-instance p1, Lcom/amap/api/col/l3s/ft;

    iget-object v0, p0, Lcom/amap/api/col/l3s/az;->g:Landroid/content/Context;

    invoke-direct {p1, v0}, Lcom/amap/api/col/l3s/ft;-><init>(Landroid/content/Context;)V

    iput-object p1, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/az;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    iget-object p1, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    invoke-virtual {p1, p0}, Lcom/amap/api/col/l3s/ft;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationListener;)V

    iget-object p1, p0, Lcom/amap/api/col/l3s/az;->f:Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;

    iget-wide v0, p0, Lcom/amap/api/col/l3s/az;->b:J
    ...
    iget-boolean v0, p0, Lcom/amap/api/col/l3s/az;->a:Z
    ...
    invoke-virtual {p1, v0}, Lcom/amap/api/col/l3s/ft;->a(Lcom/autonavi/amap/mapcore/Inner_3dMap_locationOption;)V

    iget-object p0, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    invoke-virtual {p0}, Lcom/amap/api/col/l3s/ft;->a()V
...
.method public final deactivate()V
    ...
    iput-object v0, p0, Lcom/amap/api/col/l3s/az;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;

    iget-object v1, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/amap/api/col/l3s/ft;->b()V

    iget-object v1, p0, Lcom/amap/api/col/l3s/az;->e:Lcom/amap/api/col/l3s/ft;

    invoke-virtual {v1}, Lcom/amap/api/col/l3s/ft;->c()V
...
.method public final onLocationChanged(Lcom/autonavi/amap/mapcore/Inner_3dMap_location;)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/col/l3s/az;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;
    ...
    :cond_0
    iget-object v0, p0, Lcom/amap/api/col/l3s/az;->c:Landroid/os/Bundle;
    ...
    iget-object p0, p0, Lcom/amap/api/col/l3s/az;->d:Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;

    invoke-interface {p0, p1}, Lcom/amap/api/maps/LocationSource$OnLocationChangedListener;->onLocationChanged(Landroid/location/Location;)V
    :try_end_0
