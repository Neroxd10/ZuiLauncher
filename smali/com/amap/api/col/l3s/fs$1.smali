.class final Lcom/amap/api/col/l3s/fs$1;
...
.method constructor <init>(Lcom/amap/api/col/l3s/fs;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/fs$1;->a:Lcom/amap/api/col/l3s/fs;
...
.method public final onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/col/l3s/fs$1;->a:Lcom/amap/api/col/l3s/fs;
    ...
    iget-object v1, p0, Lcom/amap/api/col/l3s/fs$1;->a:Lcom/amap/api/col/l3s/fs;
    ...
    iget-object p2, p0, Lcom/amap/api/col/l3s/fs$1;->a:Lcom/amap/api/col/l3s/fs;

    invoke-static {p2}, Lcom/amap/api/col/l3s/fs;->c(Lcom/amap/api/col/l3s/fs;)Landroid/widget/ImageView;

    move-result-object p2

    iget-object p0, p0, Lcom/amap/api/col/l3s/fs$1;->a:Lcom/amap/api/col/l3s/fs;

    invoke-static {p0}, Lcom/amap/api/col/l3s/fs;->b(Lcom/amap/api/col/l3s/fs;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0}, Lcom/amap/api/col/l3s/fs;->d(Lcom/amap/api/col/l3s/fs;)Landroid/graphics/Bitmap;
    ...
    const-string v0, "zoomin ontouch"
