.class public final Lcom/amap/api/col/l3s/oy;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/api/col/l3s/oy;->b:Ljava/util/List;
...
.method private static a(D)D
    ...
    sget-wide v0, Lcom/amap/api/col/l3s/oy;->a:D
...
.method private static a(DDDD)Lcom/amap/api/location/DPoint;
    ...
    invoke-static {p4, p5, p6, p7}, Lcom/amap/api/col/l3s/oy;->c(DD)Lcom/amap/api/location/DPoint;
    ...
    invoke-static {p0, p1}, Lcom/amap/api/col/l3s/oy;->c(D)D
    ...
    invoke-static {p2, p3}, Lcom/amap/api/col/l3s/oy;->c(D)D
...
.method public static a(Landroid/content/Context;Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
    ...
    :cond_0
    invoke-static {p1}, Lcom/amap/api/col/l3s/oy;->b(Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
...
.method public static a(Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/amap/api/col/l3s/ow;->a(DD)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static/range {p0 .. p0}, Lcom/amap/api/col/l3s/oy;->c(Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
    ...
    sget-object v0, Lcom/amap/api/col/l3s/oy;->b:Ljava/util/List;

    invoke-static {v4, v0}, Lcom/amap/api/col/l3s/ow;->a(Lcom/amap/api/location/DPoint;Ljava/util/List;)Z
    ...
    sget-wide v25, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v29, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v31, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v35, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v7, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v17, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v13, Lcom/amap/api/col/l3s/oy;->a:D
    ...
    sget-wide v15, Lcom/amap/api/col/l3s/oy;->a:D
...
.method public static b(Landroid/content/Context;Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/amap/api/col/l3s/oy;->a(DD)D
    ...
    invoke-static {v0, v1, v2, v3}, Lcom/amap/api/col/l3s/oy;->b(DD)D
    ...
    invoke-static {v8, v9, v6, v7}, Lcom/amap/api/col/l3s/oy;->a(DD)D
    ...
    invoke-static {v8, v9, v6, v7}, Lcom/amap/api/col/l3s/oy;->b(DD)D
    ...
    invoke-static {p0, v2}, Lcom/amap/api/col/l3s/oy;->a(Landroid/content/Context;Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
...
.method private static c(DD)Lcom/amap/api/location/DPoint;
    ...
    invoke-static {p0, p1}, Lcom/amap/api/col/l3s/oy;->b(D)D
    ...
    invoke-static {p2, p3}, Lcom/amap/api/col/l3s/oy;->a(D)D
    ...
    invoke-static {v1, v2}, Lcom/amap/api/col/l3s/oy;->c(D)D
...
.method private static c(Lcom/amap/api/location/DPoint;)Lcom/amap/api/location/DPoint;
    ...
    invoke-static/range {v6 .. v13}, Lcom/amap/api/col/l3s/oy;->a(DDDD)Lcom/amap/api/location/DPoint;
