.class public final Lcom/amap/api/col/l3s/lb;
...
.method public constructor <init>(Landroid/content/Context;Ljavax/net/ssl/SSLContext;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/lb;->b:Landroid/content/Context;

    :cond_0
    iput-object p2, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/lb;->a:Ljavax/net/ssl/SSLSocketFactory;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_2

    :cond_1
    :try_start_1
    iget-object p1, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    :try_end_1
    ...
    invoke-static {p1, v3, v2}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V

    :cond_2
    :goto_0
    :try_start_2
    iget-object p1, p0, Lcom/amap/api/col/l3s/lb;->a:Ljavax/net/ssl/SSLSocketFactory;
    ...
    invoke-static {p0, v3, v0}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, v3, p2}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    :try_start_6
    iget-object p2, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    ...
    invoke-static {p2, v3, v2}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V

    :cond_6
    :goto_4
    :try_start_7
    iget-object p2, p0, Lcom/amap/api/col/l3s/lb;->a:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iput-object p2, p0, Lcom/amap/api/col/l3s/lb;->a:Ljavax/net/ssl/SSLSocketFactory;
    :try_end_7
...
.method private static a(Ljava/net/Socket;)Ljava/net/Socket;
    ...
    :cond_0
    sget-boolean v0, Lcom/amap/api/col/l3s/iv$f;->b:Z
...
.method private a(Landroid/net/SSLSessionCache;)V
    ...
    iget-object p0, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    ...
    const-string v1, "UbVNlc3Npb25DYWNoZQ"
    ...
    const-string v2, "Yc2V0UGVyc2lzdGVudENhY2hl"
    ...
    const-string p1, "myssl"

    const-string v0, "isc2"
...
.method private static b(Ljava/net/Socket;)V
    ...
    :cond_0
    sget-boolean v0, Lcom/amap/api/col/l3s/iv$f;->c:Z

    if-eqz v0, :cond_5

    sget-boolean v0, Lcom/amap/api/col/l3s/iv$f;->e:Z
    ...
    :cond_2
    sget v0, Lcom/amap/api/col/l3s/iv$f;->f:I

    sget v2, Lcom/amap/api/col/l3s/iv$f;->d:I
    ...
    :cond_3
    sget v2, Lcom/amap/api/col/l3s/iv$f;->f:I
...
.method public final a()V
    ...
    :cond_1
    iget-object v0, p0, Lcom/amap/api/col/l3s/lb;->b:Landroid/content/Context;

    if-eqz v0, :cond_5

    iget-object v0, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    ...
    :cond_2
    sget v0, Lcom/amap/api/col/l3s/iv$f;->d:I
    ...
    iget-object v1, p0, Lcom/amap/api/col/l3s/lb;->b:Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/amap/api/col/l3s/lb;->c:Ljavax/net/ssl/SSLContext;
    ...
    invoke-direct {p0, v0}, Lcom/amap/api/col/l3s/lb;->a(Landroid/net/SSLSessionCache;)V
...
.method public final createSocket()Ljava/net/Socket;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amap/api/col/l3s/lb;->a:Ljavax/net/ssl/SSLSocketFactory;

    if-eqz v0, :cond_0

    iget-object p0, p0, Lcom/amap/api/col/l3s/lb;->a:Ljavax/net/ssl/SSLSocketFactory;

    invoke-virtual {p0}, Ljavax/net/ssl/SSLSocketFactory;->createSocket()Ljava/net/Socket;

    move-result-object p0

    invoke-static {p0}, Lcom/amap/api/col/l3s/lb;->a(Ljava/net/Socket;)Ljava/net/Socket;

    move-result-object p0

    invoke-static {p0}, Lcom/amap/api/col/l3s/lb;->b(Ljava/net/Socket;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
