.class public final Lcom/amap/api/col/l3s/ow;
...
.field static b:Ljava/lang/String; = "http://dualstack.apilocate.amap.com/mobile/binary"

.field static c:Ljava/lang/String; = ""

.field static d:Ljava/lang/String; = "11G;11K;13J;13S;15O;15U;17J;17Y"
...
.field static k:Ljava/util/HashMap; = null
...
.field private static o:Lcom/amap/api/col/l3s/je; = null
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/amap/api/col/l3s/ow;->n:[Ljava/lang/String;
...
.method public static a()Ljava/lang/String;
    ...
    sget-object v0, Lcom/amap/api/col/l3s/ow;->a:Ljava/lang/String;
...
.method public static a(Landroid/content/Context;)V
    ...
    :try_start_0
    invoke-static {p0}, Lcom/amap/api/col/l3s/jf;->b(Landroid/content/Context;)Z
    ...
    sput-object p0, Lcom/amap/api/col/l3s/ow;->a:Ljava/lang/String;
    :try_end_0
    ...
    :cond_0
    :try_start_1
    sget-object v2, Lcom/amap/api/col/l3s/ow;->k:Ljava/util/HashMap;
    ...
    sput-object v2, Lcom/amap/api/col/l3s/ow;->k:Ljava/util/HashMap;
    ...
    invoke-static {v2, v1, v3}, Lcom/amap/api/col/l3s/ow;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Lcom/amap/api/col/l3s/ol;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    sput-object p0, Lcom/amap/api/col/l3s/ow;->j:Ljava/lang/String;
    :try_end_2
    ...
    invoke-static {v2}, Lcom/amap/api/col/l3s/ow;->a(Ljava/lang/String;)[B
    ...
    sput-object v3, Lcom/amap/api/col/l3s/ow;->c:Ljava/lang/String;

    sput-object v3, Lcom/amap/api/col/l3s/ow;->a:Ljava/lang/String;
    :try_end_3
    ...
    :try_start_4
    invoke-static {p0, v1, v0}, Lcom/amap/api/col/l3s/ow;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_4
...
.method public static a(Lcom/amap/api/location/AMapLocation;Lorg/json/JSONObject;)V
    ...
    :cond_3
    invoke-static {v4, v5, v6, v7}, Lcom/amap/api/col/l3s/ow;->a(DD)Z
...
.method public static a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    instance-of v0, p0, Lcom/amap/api/col/l3s/it;
...
.method public static a(DD)Z
    ...
    invoke-static {p0, p1, p3}, Lcom/amap/api/col/l3s/ow;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static a(DDDDDD)Z
    ...
    invoke-static/range {p0 .. p11}, Lcom/amap/api/col/l3s/ow;->b(DDDDDD)D
...
.method public static a(Lcom/amap/api/location/DPoint;Ljava/util/List;)Z
    ...
    invoke-static/range {v1 .. v12}, Lcom/amap/api/col/l3s/ow;->a(DDDDDD)Z
...
.method private static a(Ljava/lang/String;)[B
    ...
    invoke-static {v3}, Lcom/amap/api/col/l3s/pc;->h(Ljava/lang/String;)I
...
.method public static b()Ljava/lang/String;
    ...
    sget-object v0, Lcom/amap/api/col/l3s/ow;->b:Ljava/lang/String;
...
.method public static c()Lcom/amap/api/col/l3s/je;
    .locals 4

    const-string v0, "5.2.0"

    :try_start_0
    sget-object v1, Lcom/amap/api/col/l3s/ow;->o:Lcom/amap/api/col/l3s/je;
    ...
    sget-object v2, Lcom/amap/api/col/l3s/ow;->n:[Ljava/lang/String;
    ...
    sput-object v0, Lcom/amap/api/col/l3s/ow;->o:Lcom/amap/api/col/l3s/je;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_0
    :goto_0
    sget-object v0, Lcom/amap/api/col/l3s/ow;->o:Lcom/amap/api/col/l3s/je;
...
.method public static c(Landroid/content/Context;)V
    ...
    sput-object v0, Lcom/amap/api/col/l3s/ow;->a:Ljava/lang/String;

    sput-object v0, Lcom/amap/api/col/l3s/ow;->b:Ljava/lang/String;
    ...
    const-string p0, "http://dualstack.apilocate.amap.com/mobile/binary"

    sput-object p0, Lcom/amap/api/col/l3s/ow;->b:Ljava/lang/String;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static d()Ljava/lang/String;
    ...
    sget-object v0, Lcom/amap/api/col/l3s/ow;->d:Ljava/lang/String;
