.class public final Lcom/amap/api/col/l3s/qe;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
...
# virtual methods
.method public final a(Ljava/lang/String;Landroid/content/Context;Lcom/amap/api/col/l3s/le;)Lcom/amap/api/col/l3s/qb;
    .locals 6

    const-string v0, "status"

    new-instance v1, Lcom/amap/api/col/l3s/qb;

    const-string v2, ""

    invoke-direct {v1, v2}, Lcom/amap/api/col/l3s/qb;-><init>(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v3, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    iget-object p1, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    iget-object v0, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    const-string v0, "MapParser"

    const-string v2, "paseAuthFailurJson"

    invoke-static {p1, v0, v2}, Lcom/amap/api/col/l3s/pq;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p3, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    :catchall_1
    :cond_4
    iget-object p2, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    iget-object p0, p0, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
...
.method public final a([B)Lcom/amap/api/col/l3s/qb;
    .locals 16
    ...
    :try_start_0
    new-instance v0, Lcom/amap/api/col/l3s/qb;

    invoke-direct {v0, v2}, Lcom/amap/api/col/l3s/qb;-><init>(Ljava/lang/String;)V

    if-nez p1, :cond_0

    invoke-virtual {v0, v4}, Lcom/autonavi/amap/mapcore/Inner_3dMap_location;->setErrorCode(I)V

    iget-object v6, v1, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    iget-object v7, v1, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v0, v6}, Lcom/amap/api/col/l3s/qb;->b(Ljava/lang/String;)V
    ...
    invoke-static {v6, v7}, Lcom/amap/api/col/l3s/pu;->a(D)D
    ...
    invoke-virtual {v0, v6}, Lcom/amap/api/col/l3s/qb;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v6}, Lcom/amap/api/col/l3s/qb;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v9}, Lcom/amap/api/col/l3s/qb;->e(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v6}, Lcom/amap/api/col/l3s/qb;->setFloor(Ljava/lang/String;)V
    :try_end_20
    ...
    invoke-virtual {v0, v2}, Lcom/amap/api/col/l3s/qb;->a(Ljava/lang/String;)V
    :try_end_22
    ...
    :try_start_23
    new-instance v3, Lcom/amap/api/col/l3s/qb;

    invoke-direct {v3, v2}, Lcom/amap/api/col/l3s/qb;-><init>(Ljava/lang/String;)V

    invoke-virtual {v3, v4}, Lcom/autonavi/amap/mapcore/Inner_3dMap_location;->setErrorCode(I)V

    iget-object v2, v1, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    iget-object v0, v1, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
    ...
    iget-object v1, v1, Lcom/amap/api/col/l3s/qe;->a:Ljava/lang/StringBuilder;
