.class public final Lcom/amap/api/col/l3s/bl;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/amap/api/col/l3s/bl;->a:Ljava/util/ArrayList;

    iput-object p1, p0, Lcom/amap/api/col/l3s/bl;->c:Landroid/content/Context;

    invoke-static {p1}, Lcom/amap/api/col/l3s/bw;->a(Landroid/content/Context;)Lcom/amap/api/col/l3s/bw;

    move-result-object p1

    iput-object p1, p0, Lcom/amap/api/col/l3s/bl;->b:Lcom/amap/api/col/l3s/bw;

    return-void
.end method

.method private a(Lcom/amap/api/col/l3s/br;)V
    .locals 0

    iget-object p0, p0, Lcom/amap/api/col/l3s/bl;->b:Lcom/amap/api/col/l3s/bw;

    if-eqz p0, :cond_0

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lcom/amap/api/col/l3s/bw;->a(Lcom/amap/api/col/l3s/br;)V
...
.method private b(Lcom/amap/api/col/l3s/bg;)V
    .locals 5

    new-instance v0, Ljava/io/File;

    iget-object p0, p0, Lcom/amap/api/col/l3s/bl;->c:Landroid/content/Context;
...
.method private b(Lcom/amap/api/col/l3s/br;)V
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lcom/amap/api/col/l3s/bw;->b(Lcom/amap/api/col/l3s/br;)V
...
.method public final a(Ljava/lang/String;)Lcom/amap/api/maps/offlinemap/OfflineMapCity;
    ...
    :cond_0
    iget-object v1, p0, Lcom/amap/api/col/l3s/bl;->a:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object p0, p0, Lcom/amap/api/col/l3s/bl;->a:Ljava/util/ArrayList;
...
.method public final a(Lcom/amap/api/col/l3s/bg;)V
    ...
    :try_start_0
    iget-object v2, p0, Lcom/amap/api/col/l3s/bl;->a:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Lcom/amap/api/col/l3s/bg;->l:Lcom/amap/api/col/l3s/ck;

    invoke-virtual {v0}, Lcom/amap/api/col/l3s/ck;->b()I

    move-result v0

    iget-object v2, p1, Lcom/amap/api/col/l3s/bg;->l:Lcom/amap/api/col/l3s/ck;

    iget-object v4, p1, Lcom/amap/api/col/l3s/bg;->a:Lcom/amap/api/col/l3s/ck;
    ...
    invoke-virtual {p1}, Lcom/amap/api/col/l3s/bg;->p()Lcom/amap/api/col/l3s/br;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/amap/api/col/l3s/bl;->b(Lcom/amap/api/col/l3s/br;)V
    ...
    iget-object v7, p1, Lcom/amap/api/col/l3s/bg;->f:Lcom/amap/api/col/l3s/ck;
    ...
    invoke-direct {p0, p1}, Lcom/amap/api/col/l3s/bl;->b(Lcom/amap/api/col/l3s/bg;)V

    invoke-virtual {p1}, Lcom/amap/api/col/l3s/bg;->p()Lcom/amap/api/col/l3s/br;

    move-result-object v2

    invoke-virtual {v2}, Lcom/amap/api/col/l3s/br;->b()V
    ...
    iget-object v7, p1, Lcom/amap/api/col/l3s/bg;->l:Lcom/amap/api/col/l3s/ck;

    invoke-virtual {v7}, Lcom/amap/api/col/l3s/ck;->b()I
    ...
    invoke-direct {p0, v2}, Lcom/amap/api/col/l3s/bl;->a(Lcom/amap/api/col/l3s/br;)V
    ...
    new-instance p1, Lcom/amap/api/col/l3s/br;

    iget-object v0, p0, Lcom/amap/api/col/l3s/bl;->c:Landroid/content/Context;

    invoke-direct {p1, v3, v0}, Lcom/amap/api/col/l3s/br;-><init>(Lcom/amap/api/maps/offlinemap/OfflineMapProvince;Landroid/content/Context;)V

    invoke-direct {p0, p1}, Lcom/amap/api/col/l3s/bl;->b(Lcom/amap/api/col/l3s/br;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {p1, p0}, Lcom/amap/api/col/l3s/ce;->a(Ljava/lang/String;Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-static {v3}, Lcom/amap/api/col/l3s/bl;->a(Lcom/amap/api/maps/offlinemap/OfflineMapProvince;)Z
    ...
    iget-object v2, p0, Lcom/amap/api/col/l3s/bl;->c:Landroid/content/Context;

    invoke-direct {v0, v3, v2}, Lcom/amap/api/col/l3s/br;-><init>(Lcom/amap/api/maps/offlinemap/OfflineMapProvince;Landroid/content/Context;)V

    invoke-virtual {p1}, Lcom/amap/api/col/l3s/bg;->a()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0, v2}, Lcom/amap/api/col/l3s/br;->a(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/amap/api/maps/offlinemap/City;->getCode()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, p1}, Lcom/amap/api/col/l3s/bu;->d(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/amap/api/col/l3s/bl;->c:Landroid/content/Context;

    invoke-direct {v0, v3, p1}, Lcom/amap/api/col/l3s/br;-><init>(Lcom/amap/api/maps/offlinemap/OfflineMapProvince;Landroid/content/Context;)V

    :goto_3
    invoke-virtual {v0}, Lcom/amap/api/col/l3s/br;->b()V

    invoke-direct {p0, v0}, Lcom/amap/api/col/l3s/bl;->a(Lcom/amap/api/col/l3s/br;)V

    new-instance p0, Ljava/lang/StringBuilder;

    const-string p1, "saveJSONObjectToFile  province "

    invoke-direct {p0, p1}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0}, Lcom/amap/api/col/l3s/bu;->c()Ljava/lang/String;
...
.method public final a(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/amap/api/col/l3s/bl;->a:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v3, p0, Lcom/amap/api/col/l3s/bl;->a:Ljava/util/ArrayList;
...
.method public final d()Ljava/util/ArrayList;
    ...
    invoke-virtual {v2}, Lcom/amap/api/maps/offlinemap/OfflineMapProvince;->getState()I
...
.method public final e()Ljava/util/ArrayList;
    ...
    invoke-static {v4}, Lcom/amap/api/col/l3s/bl;->a(I)Z
...
.method public final f()Ljava/util/ArrayList;
    ...
    invoke-static {v3}, Lcom/amap/api/col/l3s/bl;->a(I)Z
...
.method public final g()V
    ...
    iput-object v0, p0, Lcom/amap/api/col/l3s/bl;->b:Lcom/amap/api/col/l3s/bw;

    iput-object v0, p0, Lcom/amap/api/col/l3s/bl;->c:Landroid/content/Context;
