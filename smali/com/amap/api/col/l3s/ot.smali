.class public final Lcom/amap/api/col/l3s/ot;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;

    new-instance v0, Lcom/amap/api/location/AMapLocationClientOption;

    invoke-direct {v0}, Lcom/amap/api/location/AMapLocationClientOption;-><init>()V

    iput-object v0, p0, Lcom/amap/api/col/l3s/ot;->b:Lcom/amap/api/location/AMapLocationClientOption;

    return-void
.end method

.method private a(Lcom/amap/api/col/l3s/of;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 3
    ...
    invoke-direct {p0, p2, p3, v0}, Lcom/amap/api/col/l3s/ot;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    invoke-direct {p0, p8, p7, v0, p1}, Lcom/amap/api/col/l3s/ot;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Lcom/amap/api/col/l3s/of;)V
    ...
    invoke-virtual {p1, p2}, Lcom/amap/api/col/l3s/of;->g(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/amap/api/col/l3s/ot;->b:Lcom/amap/api/location/AMapLocationClientOption;
    ...
    sget-object p2, Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;->EN:Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;
    ...
    :goto_0
    invoke-virtual {p1, p0}, Lcom/amap/api/location/AMapLocation;->setAddress(Ljava/lang/String;)V
...
.method private a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/StringBuilder;Lcom/amap/api/col/l3s/of;)V
    .locals 0
    ...
    sget-object p1, Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;->EN:Lcom/amap/api/location/AMapLocationClientOption$GeoLanguage;
    ...
    :goto_0
    invoke-virtual {p4, p0}, Lcom/amap/api/location/AMapLocation;->setDescription(Ljava/lang/String;)V
...
# virtual methods
.method public final a(Lcom/amap/api/col/l3s/of;[BLcom/amap/api/col/l3s/nz;)Lcom/amap/api/col/l3s/of;
    .locals 21
    ...
    invoke-virtual {v11, v1}, Lcom/amap/api/col/l3s/nz;->f(Ljava/lang/String;)V

    iget-object v1, v10, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;
    ...
    iget-object v2, v10, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v0, v1}, Lcom/amap/api/col/l3s/of;->b(Ljava/lang/String;)V
    ...
    invoke-static {v1, v2}, Lcom/amap/api/col/l3s/pc;->a(D)D
    ...
    invoke-virtual {v0, v1}, Lcom/amap/api/col/l3s/of;->c(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lcom/amap/api/col/l3s/of;->d(Ljava/lang/String;)V
    ...
    :try_start_1f
    invoke-direct/range {v1 .. v9}, Lcom/amap/api/col/l3s/ot;->a(Lcom/amap/api/col/l3s/of;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1f
    ...
    invoke-virtual {v0, v3}, Lcom/amap/api/col/l3s/of;->a(Ljava/lang/String;)V
    :try_end_26
    ...
    invoke-virtual/range {p1 .. p1}, Lcom/amap/api/col/l3s/of;->d()Ljava/lang/String;
    ...
    invoke-direct {v1, v2}, Lcom/amap/api/col/l3s/of;-><init>(Ljava/lang/String;)V

    const/4 v2, 0x5

    invoke-virtual {v1, v2}, Lcom/amap/api/location/AMapLocation;->setErrorCode(I)V

    invoke-virtual {v11, v12}, Lcom/amap/api/col/l3s/nz;->f(Ljava/lang/String;)V
    ...
    invoke-static {v2, v0}, Lcom/amap/api/col/l3s/pa;->a(Ljava/lang/String;I)V

    iget-object v0, v10, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;
...
.method public final a(Ljava/lang/String;)Lcom/amap/api/col/l3s/of;
    .locals 13

    const/4 v0, 0x0

    :try_start_0
    new-instance v10, Lcom/amap/api/col/l3s/of;

    const-string v1, ""

    invoke-direct {v10, v1}, Lcom/amap/api/col/l3s/of;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/amap/api/col/l3s/ot;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v4}, Lcom/amap/api/col/l3s/ot;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/amap/api/col/l3s/ot;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/amap/api/col/l3s/ot;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final a(Ljava/lang/String;Landroid/content/Context;Lcom/amap/api/col/l3s/le;Lcom/amap/api/col/l3s/nz;)Lcom/amap/api/col/l3s/of;
    .locals 9
    ...
    new-instance v3, Lcom/amap/api/col/l3s/of;

    const-string v4, ""

    invoke-direct {v3, v4}, Lcom/amap/api/col/l3s/of;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lcom/amap/api/col/l3s/iu;->e(Landroid/content/Context;)Ljava/lang/String;

    move-result-object p2

    invoke-virtual {v4, p2}, Ljava/lang/StringBuffer;->append(Ljava/lang/String;)Ljava/lang/StringBuffer;

    iget-object p2, p3, Lcom/amap/api/col/l3s/le;->b:Ljava/util/Map;
    ...
    :cond_0
    iget-object p2, p3, Lcom/amap/api/col/l3s/le;->c:Ljava/lang/String;
    ...
    :cond_2
    invoke-virtual {p4, v1}, Lcom/amap/api/col/l3s/nz;->f(Ljava/lang/String;)V

    iget-object v6, p0, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;
    ...
    invoke-virtual {p4, v0}, Lcom/amap/api/col/l3s/nz;->f(Ljava/lang/String;)V

    iget-object p1, p0, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;
    ...
    iget-object p1, p3, Lcom/amap/api/col/l3s/le;->d:Ljava/lang/String;

    invoke-static {p1, p2, v1}, Lcom/amap/api/col/l3s/pa;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-virtual {p4, p2}, Lcom/amap/api/col/l3s/nz;->f(Ljava/lang/String;)V

    iget-object p3, p0, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, p2, p3}, Lcom/amap/api/col/l3s/ow;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lcom/amap/api/col/l3s/ot;->a:Ljava/lang/StringBuilder;

    invoke-virtual {p0}, Ljava/lang/StringBuilder;->length()I

    move-result p1

    invoke-virtual {p0, v5, p1}, Ljava/lang/StringBuilder;->delete(II)Ljava/lang/StringBuilder;
...
.method public final a(Lcom/amap/api/location/AMapLocationClientOption;)V
    ...
    iput-object p1, p0, Lcom/amap/api/col/l3s/ot;->b:Lcom/amap/api/location/AMapLocationClientOption;
