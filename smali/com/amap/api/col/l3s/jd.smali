.class public final Lcom/amap/api/col/l3s/jd;
...
.method public static a(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    invoke-static {p0, v0}, Lcom/amap/api/col/l3s/jd;->a(Landroid/content/Context;Ljava/net/URI;)Ljava/net/Proxy;
    ...
    :cond_0
    invoke-static {p0}, Lcom/amap/api/col/l3s/jd;->b(Landroid/content/Context;)Ljava/net/Proxy;
...
.method private static a(Landroid/content/Context;Ljava/net/URI;)Ljava/net/Proxy;
    ...
    invoke-static {p0}, Lcom/amap/api/col/l3s/jd;->c(Landroid/content/Context;)Z
...
.method private static b(Landroid/content/Context;)Ljava/net/Proxy;
    ...
    invoke-static/range {p0 .. p0}, Lcom/amap/api/col/l3s/jd;->c(Landroid/content/Context;)Z
    ...
    invoke-static {}, Lcom/amap/api/col/l3s/jd;->a()Ljava/lang/String;

    move-result-object v0

    invoke-static {}, Lcom/amap/api/col/l3s/jd;->b()I
    ...
    invoke-static {v1, v7, v6}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v7, v1}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v7, v12}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static/range {p0 .. p0}, Lcom/amap/api/col/l3s/iy;->s(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v0, v7, v1}, Lcom/amap/api/col/l3s/jx;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v2, v7, v6}, Lcom/amap/api/col/l3s/ka;->c(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
