...
# instance fields
.field private mBounds:Lcom/amap/api/col/l3s/eb;
...
.method private a(I)[D
    ...
    iget-object v6, v0, Lcom/amap/api/maps/model/HeatmapTileProvider;->mBounds:Lcom/amap/api/col/l3s/eb;
    ...
    iget-wide v8, v6, Lcom/amap/api/col/l3s/eb;->a:D

    iget-wide v10, v6, Lcom/amap/api/col/l3s/eb;->c:D

    iget-wide v12, v6, Lcom/amap/api/col/l3s/eb;->b:D

    iget-wide v14, v6, Lcom/amap/api/col/l3s/eb;->d:D
...
.method private b(Ljava/util/Collection;)V
    ...
    invoke-static {v0}, Lcom/amap/api/maps/model/HeatmapTileProvider;->c(Ljava/util/Collection;)Lcom/amap/api/col/l3s/eb;

    move-result-object p1

    iput-object p1, p0, Lcom/amap/api/maps/model/HeatmapTileProvider;->mBounds:Lcom/amap/api/col/l3s/eb;

    new-instance v0, Lcom/amap/api/maps/model/a;

    invoke-direct {v0, p1}, Lcom/amap/api/maps/model/a;-><init>(Lcom/amap/api/col/l3s/eb;)V
...
.method private static c(Ljava/util/Collection;)Lcom/amap/api/col/l3s/eb;
    .locals 19
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_4
    new-instance v0, Lcom/amap/api/col/l3s/eb;

    move-object v10, v0

    invoke-direct/range {v10 .. v18}, Lcom/amap/api/col/l3s/eb;-><init>(DDDD)V
...
.method public getTile(III)Lcom/amap/api/maps/model/Tile;
    ...
    new-instance v4, Lcom/amap/api/col/l3s/eb;
    ...
    invoke-direct/range {v20 .. v28}, Lcom/amap/api/col/l3s/eb;-><init>(DDDD)V
    ...
    invoke-virtual {v5, v4}, Lcom/amap/api/maps/model/a;->a(Lcom/amap/api/col/l3s/eb;)Ljava/util/Collection;
    ...
    :goto_1
    new-instance v5, Lcom/amap/api/col/l3s/eb;
    ...
    invoke-direct/range {v15 .. v23}, Lcom/amap/api/col/l3s/eb;-><init>(DDDD)V

    new-instance v1, Lcom/amap/api/col/l3s/eb;

    iget-object v2, v0, Lcom/amap/api/maps/model/HeatmapTileProvider;->mBounds:Lcom/amap/api/col/l3s/eb;
    ...
    iget-wide v3, v2, Lcom/amap/api/col/l3s/eb;->c:D

    add-double v29, v3, v11

    iget-wide v3, v2, Lcom/amap/api/col/l3s/eb;->b:D

    sub-double v31, v3, v11

    iget-wide v2, v2, Lcom/amap/api/col/l3s/eb;->d:D

    add-double v33, v2, v11

    move-object/from16 v26, v1

    invoke-direct/range {v26 .. v34}, Lcom/amap/api/col/l3s/eb;-><init>(DDDD)V

    invoke-virtual {v5, v1}, Lcom/amap/api/col/l3s/eb;->a(Lcom/amap/api/col/l3s/eb;)Z
    ...
    invoke-virtual {v1, v5}, Lcom/amap/api/maps/model/a;->a(Lcom/amap/api/col/l3s/eb;)Ljava/util/Collection;
    ...
    iget-object v0, v0, Lcom/amap/api/maps/model/HeatmapTileProvider;->mMaxIntensity:[D
    ...
    invoke-static {v1, v1, v0}, Lcom/amap/api/maps/model/Tile;->obtain(II[B)Lcom/amap/api/maps/model/Tile;
