...
.method private static a(Landroid/content/Context;)V
    ...
    new-instance v0, Lcom/amap/api/col/l3s/iq;

    invoke-virtual {p0}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p0

    invoke-direct {v0, p0}, Lcom/amap/api/col/l3s/iq;-><init>(Landroid/content/Context;)V
...
.method public destroy()V
    ...
    sget-object p0, Lcom/amap/api/trace/LBSTraceClient;->a:Lcom/amap/api/trace/LBSTraceBase;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lcom/amap/api/trace/LBSTraceBase;->destroy()V

    const/4 p0, 0x0

    sput-object p0, Lcom/amap/api/trace/LBSTraceClient;->a:Lcom/amap/api/trace/LBSTraceBase;
...
.method public queryProcessedTrace(ILjava/util/List;ILcom/amap/api/trace/TraceListener;)V
    ...
    invoke-interface {p0, p1, p2, p3, p4}, Lcom/amap/api/trace/LBSTraceBase;->queryProcessedTrace(ILjava/util/List;ILcom/amap/api/trace/TraceListener;)V
...
.method public startTrace(Lcom/amap/api/trace/TraceStatusListener;)V
    ...
    invoke-interface {p0, p1}, Lcom/amap/api/trace/LBSTraceBase;->startTrace(Lcom/amap/api/trace/TraceStatusListener;)V
...
.method public stopTrace()V
    ...
    invoke-interface {p0}, Lcom/amap/api/trace/LBSTraceBase;->stopTrace()V
