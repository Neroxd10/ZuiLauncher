...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/zui/cloud/network/c;->f:Z
...
.method public constructor <init>(Ljava/util/concurrent/BlockingQueue;Ljava/util/concurrent/BlockingQueue;Lcom/zui/cloud/network/b;Lcom/zui/cloud/network/s;)V
    ...
    iput-boolean v0, p0, Lcom/zui/cloud/network/c;->e:Z

    iput-object p1, p0, Lcom/zui/cloud/network/c;->a:Ljava/util/concurrent/BlockingQueue;

    iput-object p2, p0, Lcom/zui/cloud/network/c;->b:Ljava/util/concurrent/BlockingQueue;

    iput-object p3, p0, Lcom/zui/cloud/network/c;->c:Lcom/zui/cloud/network/b;

    iput-object p4, p0, Lcom/zui/cloud/network/c;->d:Lcom/zui/cloud/network/s;
...
.method static synthetic a(Lcom/zui/cloud/network/c;)Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object p0, p0, Lcom/zui/cloud/network/c;->b:Ljava/util/concurrent/BlockingQueue;
...
.method public run()V
    ...
    sget-boolean v0, Lcom/zui/cloud/network/c;->f:Z
    ...
    iget-object v0, p0, Lcom/zui/cloud/network/c;->c:Lcom/zui/cloud/network/b;
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/zui/cloud/network/c;->a:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-virtual {v0, v1}, Lcom/zui/cloud/network/n;->d(Ljava/lang/String;)V

    goto :goto_0

    :cond_2
    iget-object v1, p0, Lcom/zui/cloud/network/c;->c:Lcom/zui/cloud/network/b;
    ...
    :goto_1
    iget-object v1, p0, Lcom/zui/cloud/network/c;->b:Ljava/util/concurrent/BlockingQueue;
    ...
    iget-object v1, p0, Lcom/zui/cloud/network/c;->d:Lcom/zui/cloud/network/s;
    ...
    :catch_0
    iget-boolean v0, p0, Lcom/zui/cloud/network/c;->e:Z
