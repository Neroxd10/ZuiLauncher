.class public abstract Lcom/zui/launcher/views/AbstractSlideInView;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/zui/launcher/views/AbstractSlideInView$OnCloseListener;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/zui/launcher/views/AbstractSlideInView$a;

    const-class v1, Ljava/lang/Float;

    const-string v2, "translationShift"

    invoke-direct {v0, v1, v2}, Lcom/zui/launcher/views/AbstractSlideInView$a;-><init>(Ljava/lang/Class;Ljava/lang/String;)V

    sput-object v0, Lcom/zui/launcher/views/AbstractSlideInView;->TRANSLATION_SHIFT:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mTranslationShift:F

    new-instance p2, Ljava/util/ArrayList;

    invoke-direct {p2}, Ljava/util/ArrayList;-><init>()V

    iput-object p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mOnCloseListeners:Ljava/util/List;
    ...
    iput-object p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mActivityContext:Landroid/content/Context;

    sget-object p2, Lcom/zui/launcher/anim/Interpolators;->SCROLL_CUBIC:Landroid/view/animation/Interpolator;

    iput-object p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mScrollInterpolator:Landroid/view/animation/Interpolator;
    ...
    iput-object p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mSwipeDetector:Lcom/zui/launcher/touch/SingleAxisSwipeDetector;
    ...
    iput-object p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mOpenCloseAnimator:Landroid/animation/ObjectAnimator;

    new-instance p3, Lcom/zui/launcher/views/AbstractSlideInView$b;

    invoke-direct {p3, p0}, Lcom/zui/launcher/views/AbstractSlideInView$b;-><init>(Lcom/zui/launcher/views/AbstractSlideInView;)V

    invoke-virtual {p2, p3}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {p0, p1}, Lcom/zui/launcher/views/AbstractSlideInView;->getScrimColor(Landroid/content/Context;)I
    ...
    invoke-virtual {p0, p1, p2}, Lcom/zui/launcher/views/AbstractSlideInView;->createColorScrim(Landroid/content/Context;I)Landroid/view/View;
    ...
    :goto_0
    iput-object p1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mColorScrim:Landroid/view/View;

    return-void
.end method

.method static synthetic a(Lcom/zui/launcher/views/AbstractSlideInView;)V
    .locals 0
...
# virtual methods
.method public addOnCloseListener(Lcom/zui/launcher/views/AbstractSlideInView$OnCloseListener;)V
    .locals 0

    iget-object p0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mOnCloseListeners:Ljava/util/List;
...
.method protected attachToContainer()V
    ...
    iget-object v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mColorScrim:Landroid/view/View;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lcom/zui/launcher/views/AbstractSlideInView;->getPopupContainer()Lcom/zui/launcher/views/BaseDragLayer;

    move-result-object v0

    iget-object v1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mColorScrim:Landroid/view/View;
...
.method protected getPopupContainer()Lcom/zui/launcher/views/BaseDragLayer;
    ...
    iget-object p0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mActivityContext:Landroid/content/Context;
...
.method protected handleClose(ZJ)V
    ...
    iget-object p1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mOpenCloseAnimator:Landroid/animation/ObjectAnimator;

    invoke-virtual {p1}, Landroid/animation/ObjectAnimator;->cancel()V

    invoke-virtual {p0, v0}, Lcom/zui/launcher/views/AbstractSlideInView;->setTranslationShift(F)V
    ...
    new-instance v0, Lcom/zui/launcher/views/AbstractSlideInView$c;

    invoke-direct {v0, p0}, Lcom/zui/launcher/views/AbstractSlideInView$c;-><init>(Lcom/zui/launcher/views/AbstractSlideInView;)V

    invoke-virtual {p1, v0}, Landroid/animation/ObjectAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mSwipeDetector:Lcom/zui/launcher/touch/SingleAxisSwipeDetector;
    ...
    iget-object p2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mScrollInterpolator:Landroid/view/animation/Interpolator;
...
.method protected onCloseComplete()V
    ...
    sget-object v0, Lcom/zui/launcher/views/v;->a:Lcom/zui/launcher/views/v;
...
.method public onControllerInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mNoIntercept:Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mSwipeDetector:Lcom/zui/launcher/touch/SingleAxisSwipeDetector;

    invoke-virtual {v0}, Lcom/zui/launcher/touch/BaseSwipeDetector;->isIdleState()Z
    ...
    :goto_0
    iget-object v2, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mSwipeDetector:Lcom/zui/launcher/touch/SingleAxisSwipeDetector;

    invoke-virtual {v2, v0, v1}, Lcom/zui/launcher/touch/SingleAxisSwipeDetector;->setDetectableScrollConditions(IZ)V

    iget-object v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mSwipeDetector:Lcom/zui/launcher/touch/SingleAxisSwipeDetector;

    invoke-virtual {v0, p1}, Lcom/zui/launcher/touch/BaseSwipeDetector;->onTouchEvent(Landroid/view/MotionEvent;)Z

    iget-object v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mSwipeDetector:Lcom/zui/launcher/touch/SingleAxisSwipeDetector;

    invoke-virtual {v0}, Lcom/zui/launcher/touch/BaseSwipeDetector;->isDraggingOrSettling()Z

    move-result v0

    if-nez v0, :cond_3

    invoke-static {}, Lcom/zui/launcher/Utilities;->isDoom()Z
    ...
    invoke-virtual {v0, p0, p1}, Lcom/zui/launcher/views/BaseDragLayer;->isEventOverViewForDoom(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public onControllerTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {p0}, Lcom/zui/launcher/views/AbstractSlideInView;->b()Z
    ...
    invoke-virtual {v0, v2, p1}, Lcom/zui/launcher/views/BaseDragLayer;->isEventOverView(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public onDragEnd(F)V
    ...
    :cond_0
    iget v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mTranslationShift:F
    ...
    iput-object v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mScrollInterpolator:Landroid/view/animation/Interpolator;

    iget-object v0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mOpenCloseAnimator:Landroid/animation/ObjectAnimator;

    const/high16 v1, 0x3f800000    # 1.0f

    iget v3, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mTranslationShift:F
    ...
    sget-object v4, Lcom/zui/launcher/views/AbstractSlideInView;->TRANSLATION_SHIFT:Landroid/util/Property;
    ...
    iget v1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mTranslationShift:F
...
.method protected setTranslationShift(F)V
    ...
    iput p1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mTranslationShift:F
    ...
    iget-object p1, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mColorScrim:Landroid/view/View;

    if-eqz p1, :cond_0

    const/high16 v0, 0x3f800000    # 1.0f

    iget p0, p0, Lcom/zui/launcher/views/AbstractSlideInView;->mTranslationShift:F
