.class public Lcom/zui/launcher/widget/XWidgetsBottomSheet;
...
.field private e:Lcom/zui/launcher/util/PackageUserKey;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/zui/launcher/widget/XWidgetsBottomSheet$a;

    const-string v1, "paddingBottom"

    invoke-direct {v0, v1}, Lcom/zui/launcher/widget/XWidgetsBottomSheet$a;-><init>(Ljava/lang/String;)V

    sput-object v0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->h:Landroid/util/IntProperty;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/zui/launcher/widget/XWidgetsBottomSheet;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->d:I

    new-instance p1, Lcom/zui/launcher/widget/XWidgetsBottomSheet$b;

    invoke-direct {p1, p0}, Lcom/zui/launcher/widget/XWidgetsBottomSheet$b;-><init>(Lcom/zui/launcher/widget/XWidgetsBottomSheet;)V

    iput-object p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->f:Landroid/view/View$OnLayoutChangeListener;

    new-instance p1, Lcom/zui/launcher/widget/l;

    invoke-direct {p1, p0}, Lcom/zui/launcher/widget/l;-><init>(Lcom/zui/launcher/widget/XWidgetsBottomSheet;)V

    iput-object p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->g:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->c:Landroid/graphics/Rect;
    ...
    iget-object p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->f:Landroid/view/View$OnLayoutChangeListener;
...
.method static synthetic c(Lcom/zui/launcher/widget/XWidgetsBottomSheet;)Ljava/lang/Runnable;
    .locals 0

    iget-object p0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->g:Ljava/lang/Runnable;
...
.method private d(II)Z
    ...
    iget-object v1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->c:Landroid/graphics/Rect;
    ...
    iget p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->d:I

    if-eq p1, p2, :cond_1

    iput p2, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->d:I

    invoke-virtual {p0}, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->onWidgetsBound()V
...
.method public addHintCloseAnim(FLandroid/view/animation/Interpolator;Lcom/zui/launcher/anim/PendingAnimation;)V
    ...
    sget-object v0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->h:Landroid/util/IntProperty;
...
.method public createHintCloseAnim(F)Landroid/animation/Animator;
    ...
    iget-object v2, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->c:Landroid/graphics/Rect;
...
.method public synthetic e()V
    ...
    iget-object v0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->f:Landroid/view/View$OnLayoutChangeListener;
...
.method public synthetic f(Landroid/widget/TableRow;Lcom/zui/launcher/model/WidgetItem;)V
    ...
    invoke-virtual {p0, p1}, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->addItemCell(Landroid/view/ViewGroup;)Lcom/zui/launcher/widget/WidgetCell;
...
.method public synthetic g(Landroid/widget/TableLayout;Ljava/util/ArrayList;)V
    ...
    new-instance v1, Lcom/zui/launcher/widget/n;

    invoke-direct {v1, p0, v0}, Lcom/zui/launcher/widget/n;-><init>(Lcom/zui/launcher/widget/XWidgetsBottomSheet;Landroid/widget/TableRow;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->c:Landroid/graphics/Rect;
...
.method protected onMeasure(II)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->d(II)Z
...
.method public onWidgetsBound()V
    ...
    iget-object v0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->e:Lcom/zui/launcher/util/PackageUserKey;

    if-nez v0, :cond_0

    new-instance v0, Lcom/zui/launcher/util/PackageUserKey;

    iget-object v1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->b:Lcom/zui/launcher/ItemInfo;

    invoke-virtual {v1}, Lcom/zui/launcher/ItemInfo;->getTargetComponent()Landroid/content/ComponentName;
    ...
    iget-object v2, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->b:Lcom/zui/launcher/ItemInfo;
    ...
    :cond_0
    iget-object v1, p0, Lcom/zui/launcher/views/WidgetsAbstractSlideInView;->mActivityContext:Landroid/content/Context;
    ...
    invoke-virtual {v1, v0}, Lcom/zui/launcher/popup/PopupDataProvider;->getWidgetsForPackageUser(Lcom/zui/launcher/util/PackageUserKey;)Ljava/util/List;
    ...
    iget v2, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->d:I
    ...
    new-instance v2, Lcom/zui/launcher/widget/m;

    invoke-direct {v2, p0, v1}, Lcom/zui/launcher/widget/m;-><init>(Lcom/zui/launcher/widget/XWidgetsBottomSheet;Landroid/widget/TableLayout;)V
...
.method public populateAndShow(Lcom/zui/launcher/ItemInfo;)V
    ...
    iput-object v0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->e:Lcom/zui/launcher/util/PackageUserKey;

    iput-object p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->b:Lcom/zui/launcher/ItemInfo;
    ...
    iget-object v0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->b:Lcom/zui/launcher/ItemInfo;
    ...
    invoke-direct {p0}, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->animateOpen()V

    return-void
.end method

.method public populateAndShow(Lcom/zui/launcher/util/PackageUserKey;Ljava/lang/CharSequence;)V
    .locals 1

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->b:Lcom/zui/launcher/ItemInfo;

    iput-object p1, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->e:Lcom/zui/launcher/util/PackageUserKey;
...
.method public setInsets(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/zui/launcher/widget/XWidgetsBottomSheet;->c:Landroid/graphics/Rect;
