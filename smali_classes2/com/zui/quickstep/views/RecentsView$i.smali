.class Lcom/zui/quickstep/views/RecentsView$i;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/zui/quickstep/views/RecentsView;->createTaskMenuViewAnimation(Lcom/zui/quickstep/views/TaskView;J)Lcom/zui/launcher/util/PendingAnimation;
.end annotation
...
.field final synthetic b:Lcom/zui/quickstep/views/RecentsView;


# direct methods
.method constructor <init>(Lcom/zui/quickstep/views/RecentsView;Lcom/zui/quickstep/views/TaskView;)V
    .locals 0

    iput-object p1, p0, Lcom/zui/quickstep/views/RecentsView$i;->b:Lcom/zui/quickstep/views/RecentsView;

    iput-object p2, p0, Lcom/zui/quickstep/views/RecentsView$i;->a:Lcom/zui/quickstep/views/TaskView;
...
.method private c(Lcom/zui/launcher/util/PendingAnimation$OnEndListener;)V
    ...
    iget-object v0, p0, Lcom/zui/quickstep/views/RecentsView$i;->a:Lcom/zui/quickstep/views/TaskView;
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Lcom/zui/quickstep/views/RecentsView$i;->b:Lcom/zui/quickstep/views/RecentsView;
...
.method public a(Lcom/zui/launcher/util/PendingAnimation$OnEndListener;)V
    ...
    iget-object v0, p0, Lcom/zui/quickstep/views/RecentsView$i;->b:Lcom/zui/quickstep/views/RecentsView;

    const/4 v1, 0x1

    new-instance v2, Lcom/zui/quickstep/views/w;

    invoke-direct {v2, p0, p1}, Lcom/zui/quickstep/views/w;-><init>(Lcom/zui/quickstep/views/RecentsView$i;Lcom/zui/launcher/util/PendingAnimation$OnEndListener;)V
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/zui/quickstep/views/RecentsView$i;->c(Lcom/zui/launcher/util/PendingAnimation$OnEndListener;)V
...
.method public bridge synthetic accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/zui/quickstep/views/RecentsView$i;->a(Lcom/zui/launcher/util/PendingAnimation$OnEndListener;)V
