...
# instance fields
.field private final a:Lorg/greenrobot/greendao/InternalQueryDaoAccess;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method constructor <init>(Lorg/greenrobot/greendao/InternalQueryDaoAccess;Landroid/database/Cursor;Z)V
    ...
    iput-object p2, p0, Lorg/greenrobot/greendao/query/LazyList;->b:Landroid/database/Cursor;

    iput-object p1, p0, Lorg/greenrobot/greendao/query/LazyList;->a:Lorg/greenrobot/greendao/InternalQueryDaoAccess;

    invoke-interface {p2}, Landroid/database/Cursor;->getCount()I

    move-result p1

    iput p1, p0, Lorg/greenrobot/greendao/query/LazyList;->d:I
    ...
    iget v0, p0, Lorg/greenrobot/greendao/query/LazyList;->d:I

    invoke-direct {p3, v0}, Ljava/util/ArrayList;-><init>(I)V

    iput-object p3, p0, Lorg/greenrobot/greendao/query/LazyList;->c:Ljava/util/List;
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/LazyList;->c:Ljava/util/List;
    ...
    :cond_0
    iput-object p1, p0, Lorg/greenrobot/greendao/query/LazyList;->c:Ljava/util/List;

    :cond_1
    iget p1, p0, Lorg/greenrobot/greendao/query/LazyList;->d:I
    ...
    iput-object p1, p0, Lorg/greenrobot/greendao/query/LazyList;->e:Ljava/util/concurrent/locks/ReentrantLock;

    return-void
.end method

.method static synthetic a(Lorg/greenrobot/greendao/query/LazyList;)I
    .locals 0

    iget p0, p0, Lorg/greenrobot/greendao/query/LazyList;->d:I
...
.method protected checkCached()V
    ...
    iget-object p0, p0, Lorg/greenrobot/greendao/query/LazyList;->c:Ljava/util/List;
...
.method public close()V
    ...
    iget-object p0, p0, Lorg/greenrobot/greendao/query/LazyList;->b:Landroid/database/Cursor;
...
.method public get(I)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/LazyList;->e:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v1, p0, Lorg/greenrobot/greendao/query/LazyList;->c:Ljava/util/List;

    invoke-interface {v1, p1, v0}, Ljava/util/List;->set(ILjava/lang/Object;)Ljava/lang/Object;

    iget p1, p0, Lorg/greenrobot/greendao/query/LazyList;->f:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Lorg/greenrobot/greendao/query/LazyList;->f:I

    iget p1, p0, Lorg/greenrobot/greendao/query/LazyList;->f:I

    iget v1, p0, Lorg/greenrobot/greendao/query/LazyList;->d:I

    if-ne p1, v1, :cond_0

    iget-object p1, p0, Lorg/greenrobot/greendao/query/LazyList;->b:Landroid/database/Cursor;
    ...
    :cond_0
    iget-object p0, p0, Lorg/greenrobot/greendao/query/LazyList;->e:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public getLoadedCount()I
    ...
    iget p0, p0, Lorg/greenrobot/greendao/query/LazyList;->f:I
...
.method public isLoadedCompletely()Z
    ...
    iget v0, p0, Lorg/greenrobot/greendao/query/LazyList;->f:I
...
.method protected loadEntity(I)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/LazyList;->b:Landroid/database/Cursor;
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/LazyList;->a:Lorg/greenrobot/greendao/InternalQueryDaoAccess;
