...
.field private final e:Lorg/greenrobot/greendao/AbstractDao;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method protected constructor <init>(Lorg/greenrobot/greendao/AbstractDao;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->e:Lorg/greenrobot/greendao/AbstractDao;

    iput-object p2, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->f:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->c:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->d:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->j:Ljava/lang/String;
...
.method private a(Ljava/lang/String;Lorg/greenrobot/greendao/Property;Lorg/greenrobot/greendao/AbstractDao;Lorg/greenrobot/greendao/Property;)Lorg/greenrobot/greendao/query/Join;
    ...
    iget-object v1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->d:Ljava/util/List;
    ...
    iget-object p0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->d:Ljava/util/List;
...
.method private b(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->c:Ljava/util/List;

    invoke-interface {v0}, Ljava/util/List;->clear()V

    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->d:Ljava/util/List;
    ...
    iget-object v2, v1, Lorg/greenrobot/greendao/query/Join;->b:Lorg/greenrobot/greendao/AbstractDao;
    ...
    iget-object v2, v1, Lorg/greenrobot/greendao/query/Join;->e:Ljava/lang/String;
    ...
    iget-object v3, v1, Lorg/greenrobot/greendao/query/Join;->c:Lorg/greenrobot/greendao/Property;
    ...
    iget-object v1, v1, Lorg/greenrobot/greendao/query/Join;->d:Lorg/greenrobot/greendao/Property;
    ...
    iget-object v4, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->c:Ljava/util/List;
    ...
    :cond_1
    iget-object p2, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->d:Ljava/util/List;
    ...
    iget-object v4, v3, Lorg/greenrobot/greendao/query/Join;->f:Lorg/greenrobot/greendao/query/d;
    ...
    iget-object v3, v3, Lorg/greenrobot/greendao/query/Join;->e:Ljava/lang/String;

    iget-object v5, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->c:Ljava/util/List;
...
.method private c(Ljava/lang/StringBuilder;)I
    .locals 1

    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->g:Ljava/lang/Integer;
    ...
    iget-object p1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->c:Ljava/util/List;

    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->g:Ljava/lang/Integer;

    invoke-interface {p1, v0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->c:Ljava/util/List;
...
.method private d(Ljava/lang/StringBuilder;)I
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->h:Ljava/lang/Integer;
...
.method private f()V
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->b:Ljava/lang/StringBuilder;
    ...
    iput-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->b:Ljava/lang/StringBuilder;
    ...
    iget-object p0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->b:Ljava/lang/StringBuilder;
...
.method private g()Ljava/lang/StringBuilder;
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->e:Lorg/greenrobot/greendao/AbstractDao;

    invoke-virtual {v0}, Lorg/greenrobot/greendao/AbstractDao;->getTablename()Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->f:Ljava/lang/String;

    iget-object v2, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->e:Lorg/greenrobot/greendao/AbstractDao;

    invoke-virtual {v2}, Lorg/greenrobot/greendao/AbstractDao;->getAllColumns()[Ljava/lang/String;

    move-result-object v2

    iget-boolean v3, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->i:Z
    ...
    iget-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->f:Ljava/lang/String;

    invoke-direct {p0, v1, v0}, Lorg/greenrobot/greendao/query/QueryBuilder;->b(Ljava/lang/StringBuilder;Ljava/lang/String;)V
...
.method private varargs h(Ljava/lang/String;[Lorg/greenrobot/greendao/Property;)V
    .locals 4
    ...
    invoke-direct {p0}, Lorg/greenrobot/greendao/query/QueryBuilder;->f()V

    iget-object v3, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->b:Ljava/lang/StringBuilder;
    ...
    iget-object v2, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->j:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->b:Ljava/lang/StringBuilder;
...
.method public varargs and(Lorg/greenrobot/greendao/query/WhereCondition;Lorg/greenrobot/greendao/query/WhereCondition;[Lorg/greenrobot/greendao/query/WhereCondition;)Lorg/greenrobot/greendao/query/WhereCondition;
    ...
    iget-object p0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->a:Lorg/greenrobot/greendao/query/d;
...
.method protected append(Ljava/lang/StringBuilder;Lorg/greenrobot/greendao/Property;)Ljava/lang/StringBuilder;
    ...
    iget-object p0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->f:Ljava/lang/String;
...
.method public build()Lorg/greenrobot/greendao/query/Query;
    ...
    invoke-direct {p0}, Lorg/greenrobot/greendao/query/QueryBuilder;->g()Ljava/lang/StringBuilder;

    move-result-object v0

    invoke-direct {p0, v0}, Lorg/greenrobot/greendao/query/QueryBuilder;->c(Ljava/lang/StringBuilder;)I

    move-result v1

    invoke-direct {p0, v0}, Lorg/greenrobot/greendao/query/QueryBuilder;->d(Ljava/lang/StringBuilder;)I
    ...
    invoke-direct {p0, v0}, Lorg/greenrobot/greendao/query/QueryBuilder;->e(Ljava/lang/String;)V

    iget-object v3, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->e:Lorg/greenrobot/greendao/AbstractDao;
    ...
    invoke-static {v3, v0, p0, v1, v2}, Lorg/greenrobot/greendao/query/Query;->a(Lorg/greenrobot/greendao/AbstractDao;Ljava/lang/String;[Ljava/lang/Object;II)Lorg/greenrobot/greendao/query/Query;
...
.method public buildCount()Lorg/greenrobot/greendao/query/CountQuery;
    ...
    iget-object v1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->e:Lorg/greenrobot/greendao/AbstractDao;
    ...
    invoke-static {v1, v0, p0}, Lorg/greenrobot/greendao/query/CountQuery;->a(Lorg/greenrobot/greendao/AbstractDao;Ljava/lang/String;[Ljava/lang/Object;)Lorg/greenrobot/greendao/query/CountQuery;
...
.method public buildCursor()Lorg/greenrobot/greendao/query/CursorQuery;
    ...
    invoke-static {v3, v0, p0, v1, v2}, Lorg/greenrobot/greendao/query/CursorQuery;->a(Lorg/greenrobot/greendao/AbstractDao;Ljava/lang/String;[Ljava/lang/Object;II)Lorg/greenrobot/greendao/query/CursorQuery;
...
.method public buildDelete()Lorg/greenrobot/greendao/query/DeleteQuery;
    ...
    invoke-direct {p0, v2, v1}, Lorg/greenrobot/greendao/query/QueryBuilder;->b(Ljava/lang/StringBuilder;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->f:Ljava/lang/String;
    ...
    invoke-static {v1, v0, p0}, Lorg/greenrobot/greendao/query/DeleteQuery;->a(Lorg/greenrobot/greendao/AbstractDao;Ljava/lang/String;[Ljava/lang/Object;)Lorg/greenrobot/greendao/query/DeleteQuery;
...
.method public distinct()Lorg/greenrobot/greendao/query/QueryBuilder;
    ...
    iput-boolean v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->i:Z
...
.method public join(Lorg/greenrobot/greendao/query/Join;Lorg/greenrobot/greendao/Property;Ljava/lang/Class;Lorg/greenrobot/greendao/Property;)Lorg/greenrobot/greendao/query/Join;
    ...
    iget-object p1, p1, Lorg/greenrobot/greendao/query/Join;->e:Ljava/lang/String;
...
.method public limit(I)Lorg/greenrobot/greendao/query/QueryBuilder;
    ...
    iput-object p1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->g:Ljava/lang/Integer;
...
.method public offset(I)Lorg/greenrobot/greendao/query/QueryBuilder;
    ...
    iput-object p1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->h:Ljava/lang/Integer;
...
.method public varargs orderAsc([Lorg/greenrobot/greendao/Property;)Lorg/greenrobot/greendao/query/QueryBuilder;
    ...
    invoke-direct {p0, v0, p1}, Lorg/greenrobot/greendao/query/QueryBuilder;->h(Ljava/lang/String;[Lorg/greenrobot/greendao/Property;)V
...
.method public orderCustom(Lorg/greenrobot/greendao/Property;Ljava/lang/String;)Lorg/greenrobot/greendao/query/QueryBuilder;
    ...
    iget-object p1, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->b:Ljava/lang/StringBuilder;
...
.method public preferLocalizedStringOrder()Lorg/greenrobot/greendao/query/QueryBuilder;
    ...
    iput-object v0, p0, Lorg/greenrobot/greendao/query/QueryBuilder;->j:Ljava/lang/String;
...
.method public rx()Lorg/greenrobot/greendao/rx/RxQuery;
    ...
    invoke-virtual {p0}, Lorg/greenrobot/greendao/query/Query;->__InternalRx()Lorg/greenrobot/greendao/rx/RxQuery;
...
.method public rxPlain()Lorg/greenrobot/greendao/rx/RxQuery;
    ...
    invoke-virtual {p0}, Lorg/greenrobot/greendao/query/Query;->__internalRxPlain()Lorg/greenrobot/greendao/rx/RxQuery;
